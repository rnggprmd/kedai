...
@section('page-title', 'Modify Dish')
@section('page-subtitle', 'Update pricing, availability, or photos for your dish.')
        ...
        <form action="{{ route('admin.menus.update', $menu) }}" method="POST" enctype="multipart/form-data" class="space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="nama" class="w-full bg-slate-50 border-none rounded-2xl px-5 py-4 font-bold text-slate-900 focus:ring-2 focus:ring-indigo-600 transition-all placeholder:text-slate-300 @error('nama') ring-2 ring-rose-500 @enderror" value="{{ old('nama', $menu->nama) }}" required>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="harga" class="w-full bg-slate-50 border-none rounded-2xl pl-12 pr-5 py-4 font-bold text-slate-900 focus:ring-2 focus:ring-indigo-600 transition-all @error('harga') ring-2 ring-rose-500 @enderror" value="{{ old('harga', $menu->harga) }}" required>
                    </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="deskripsi" class="w-full bg-slate-50 border-none rounded-2xl px-5 py-4 font-medium text-slate-600 focus:ring-2 focus:ring-indigo-600 transition-all" rows="3">{{ old('deskripsi', $menu->deskripsi) }}</textarea>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    @error('gambar') <p class="text-rose-600 text-[10px] font-bold mt-2 ml-1 uppercase tracking-widest">{{ $message }}</p> @enderror
                </div>
