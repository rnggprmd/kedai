...
@section('page-title', 'Modify Table')
@section('page-subtitle', 'Update table capacity, code, or active status.')
        ...
        <form action="{{ route('admin.tables.update', $table) }}" method="POST" class="space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                    ...
                    <input type="text" name="kode_meja" class="w-full bg-slate-50 border-none rounded-2xl px-5 py-4 font-bold text-slate-900 focus:ring-2 focus:ring-indigo-600 transition-all placeholder:text-slate-300 @error('kode_meja') ring-2 ring-rose-500 @enderror" value="{{ old('kode_meja', $table->kode_meja) }}" required>
                ...
                <div>
                    ...
                    <input type="text" name="nama_meja" class="w-full bg-slate-50 border-none rounded-2xl px-5 py-4 font-bold text-slate-900 focus:ring-2 focus:ring-indigo-600 transition-all placeholder:text-slate-300 @error('nama_meja') ring-2 ring-rose-500 @enderror" value="{{ old('nama_meja', $table->nama_meja) }}" required>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                    ...
                    <input type="number" name="kapasitas" class="w-full bg-slate-50 border-none rounded-2xl px-5 py-4 font-bold text-slate-900 focus:ring-2 focus:ring-indigo-600 transition-all" value="{{ old('kapasitas', $table->kapasitas) }}" min="1" required>
                </div>
